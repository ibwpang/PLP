...
//TODO  more tests
	...
	public void testIdentConcat() throws IllegalCharException, IllegalNumberException {
		...
		assertEquals(4, token1.pos);
		assertEquals(text3.length(), token1.length);
		assertEquals(text3, token1.getText());
		
		Scanner.Token token2 = scanner.nextToken();
		assertEquals(IDENT, token2.kind);
		assertEquals(9, token2.pos);
		assertEquals(text4.length(), token2.length);
		assertEquals(text4, token2.getText());
		...
		assertEquals(text2.length(), token4.length);
	...
	@Test
	public void testComplicated() throws IllegalCharException, IllegalNumberException {
		//input string
		String input = "/*...*/a/***/\nbc!/ /*/ /**/ !\nd/*.**//**\n/P*//**\n*/ G";
		//create and initialize the scanner
		Scanner scanner = new Scanner(input);
